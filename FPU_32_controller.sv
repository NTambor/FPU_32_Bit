            ...
            if (operand != addopp || (addopp|operand) == 4'b0011) begin
                case(operand)
                    ...
                    ADD: begin
                        ...
                        adder_nextop <= {data_location,DONE,32'h0000};
                    ...
                    MULT: begin
                        //fifo inputs = 0
                        mult_nextop <= {data_location,DONE,32'h0000};
                    ...
                    ADDMULT: begin
                        adder_nextop <= {data_location,MULT,c};
                    ...
                    ADDDIV: begin
                        adder_nextop <= {data_location,DIV,c};

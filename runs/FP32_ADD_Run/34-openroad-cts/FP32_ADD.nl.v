module FP32_ADD (clk,
 ...
 sky130_fd_sc_hd__xnor2_1 _2026_ (.A(signA0),
    .B(op0),
    .Y(_1720_));
 sky130_fd_sc_hd__xnor2_1 _2027_ (.A(signB0),
    .B(_1720_),
    .Y(_0001_));
 ...
 sky130_fd_sc_hd__mux2_1 _2209_ (.A0(net1),
    ...
    .S(net98),
    .X(_1863_));
 sky130_fd_sc_hd__o21a_1 _2210_ (.A1(\expmiddlea[0] ),
    .A2(net178),
    .B1(_1863_),
    .X(_0041_));
 sky130_fd_sc_hd__mux2_1 _2211_ (.A0(net2),
    ...
    .S(net98),
    .X(_1864_));
 sky130_fd_sc_hd__o21a_1 _2212_ (.A1(\expmiddlea[1] ),
    .A2(net178),
    .B1(_1864_),
    .X(_0042_));
 sky130_fd_sc_hd__mux2_1 _2213_ (.A0(net3),
    ...
    .S(net98),
    .X(_1865_));
 sky130_fd_sc_hd__o21a_1 _2214_ (.A1(\expmiddlea[2] ),
    .A2(net178),
    .B1(_1865_),
    .X(_0043_));
 sky130_fd_sc_hd__mux2_1 _2215_ (.A0(net4),
    ...
    .S(net98),
    .X(_1866_));
 sky130_fd_sc_hd__o21a_1 _2216_ (.A1(\expmiddlea[3] ),
    .A2(net178),
    .B1(_1866_),
    .X(_0044_));
 sky130_fd_sc_hd__mux2_1 _2217_ (.A0(net5),
    ...
    .S(net98),
    .X(_1867_));
 sky130_fd_sc_hd__o21a_1 _2218_ (.A1(\expmiddlea[4] ),
    .A2(net178),
    .B1(_1867_),
    .X(_0045_));
 sky130_fd_sc_hd__mux2_1 _2219_ (.A0(net6),
    ...
    .S(net98),
    .X(_1868_));
 sky130_fd_sc_hd__o21a_1 _2220_ (.A1(\expmiddlea[5] ),
    .A2(net178),
    .B1(_1868_),
    .X(_0046_));
 sky130_fd_sc_hd__mux2_1 _2221_ (.A0(net7),
    ...
    .S(net99),
    .X(_1869_));
 sky130_fd_sc_hd__o21a_1 _2222_ (.A1(\expmiddlea[6] ),
    .A2(net178),
    .B1(_1869_),
    .X(_0047_));
 ...
 sky130_fd_sc_hd__a221o_1 _2759_ (.A1(\mantisaresult[63] ),
    ...
    .C1(net217),
    .X(_0702_));
 sky130_fd_sc_hd__o22a_1 _2760_ (.A1(\four_man[39] ),
    .A2(net206),
    .B1(_0700_),
    .B2(_0702_),
    .X(_0098_));
 ...
 sky130_fd_sc_hd__a31o_1 _2821_ (.A1(_0572_),
    ...
    .B1(net217),
    .X(_0763_));
 sky130_fd_sc_hd__o22a_1 _2822_ (.A1(\four_man[40] ),
    .A2(net208),
    .B1(_0759_),
    .B2(_0763_),
    .X(_0099_));
 ...
 sky130_fd_sc_hd__a31o_1 _2855_ (.A1(net225),
    ...
    .B1(_0795_),
    .X(_0796_));
 sky130_fd_sc_hd__o22a_1 _2856_ (.A1(\four_man[41] ),
    .A2(net208),
    .B1(_0794_),
    .B2(_0796_),
    .X(_0100_));
 ...
 sky130_fd_sc_hd__a31o_1 _2888_ (.A1(net224),
    ...
    .B1(_0827_),
    .X(_0828_));
 sky130_fd_sc_hd__o22a_1 _2889_ (.A1(\four_man[42] ),
    .A2(_1687_),
    .B1(_0826_),
    .B2(_0828_),
    .X(_0101_));
 ...
 sky130_fd_sc_hd__a31o_1 _2909_ (.A1(net223),
    ...
    .B1(_0847_),
    .X(_0848_));
 sky130_fd_sc_hd__o22a_1 _2910_ (.A1(\four_man[43] ),
    .A2(net207),
    .B1(_0846_),
    .B2(_0848_),
    .X(_0102_));
 ...
 sky130_fd_sc_hd__a31o_1 _2928_ (.A1(net222),
    ...
    .B1(_0865_),
    .X(_0866_));
 sky130_fd_sc_hd__o22a_1 _2929_ (.A1(\four_man[44] ),
    .A2(net208),
    .B1(_0864_),
    .B2(_0866_),
    .X(_0103_));
 ...
 sky130_fd_sc_hd__a31o_1 _2960_ (.A1(net221),
    ...
    .B1(_0891_),
    .X(_0892_));
 sky130_fd_sc_hd__o22a_1 _2961_ (.A1(\four_man[45] ),
    .A2(net206),
    .B1(_0890_),
    .B2(_0892_),
    .X(_0109_));
 ...
 sky130_fd_sc_hd__a31o_1 _3023_ (.A1(\mantisaresult[47] ),
    ...
    .B1(_0943_),
    .X(_0944_));
 sky130_fd_sc_hd__o22a_1 _3024_ (.A1(\four_man[46] ),
    .A2(net206),
    .B1(_0942_),
    .B2(_0944_),
    .X(_0120_));
 ...
 sky130_fd_sc_hd__a21oi_1 _3056_ (.A1(\mantisaBshift[22] ),
    ...
    .B1(net233),
    .Y(_0968_));
 sky130_fd_sc_hd__a22o_1 _3057_ (.A1(\mantisaresult[22] ),
    .A2(net233),
    .B1(_0967_),
    .B2(_0968_),
    .X(_0129_));
 ...
 sky130_fd_sc_hd__a31o_1 _3073_ (.A1(net220),
    ...
    .B1(_0982_),
    .X(_0983_));
 sky130_fd_sc_hd__o22a_1 _3074_ (.A1(\four_man[47] ),
    .A2(net206),
    .B1(_0981_),
    .B2(_0983_),
    .X(_0131_));
 ...
 sky130_fd_sc_hd__a31o_1 _3095_ (.A1(net242),
    ...
    .B1(net235),
    .X(_0999_));
 sky130_fd_sc_hd__o22a_1 _3096_ (.A1(\mantisaresult[29] ),
    .A2(net202),
    .B1(_0998_),
    .B2(_0999_),
    .X(_0137_));
 ...
 sky130_fd_sc_hd__a31o_1 _3124_ (.A1(\mantisaresult[49] ),
    ...
    .B1(_1022_),
    .X(_1023_));
 sky130_fd_sc_hd__o22a_1 _3125_ (.A1(\four_man[48] ),
    .A2(net206),
    .B1(_1021_),
    .B2(_1023_),
    .X(_0142_));
 ...
 sky130_fd_sc_hd__o41a_1 _3129_ (.A1(\mantisaBshift[32] ),
    ...
    .B1(net242),
    .X(_1026_));
 sky130_fd_sc_hd__nand2_1 _3130_ (.A(\mantisaBshift[35] ),
    .B(_1026_),
    .Y(_1027_));
 ...
 sky130_fd_sc_hd__a31o_1 _3200_ (.A1(\mantisaresult[50] ),
    ...
    .B1(_1087_),
    .X(_1088_));
 sky130_fd_sc_hd__o22a_1 _3201_ (.A1(\four_man[49] ),
    .A2(net206),
    .B1(_1086_),
    .B2(_1088_),
    .X(_0153_));
 ...
 sky130_fd_sc_hd__a31o_1 _3318_ (.A1(\mantisaresult[51] ),
    ...
    .B1(_1194_),
    .X(_1195_));
 sky130_fd_sc_hd__o22a_1 _3319_ (.A1(\four_man[50] ),
    .A2(net206),
    .B1(_1193_),
    .B2(_1195_),
    .X(_0164_));
 ...
 sky130_fd_sc_hd__a31o_1 _3437_ (.A1(net219),
    ...
    .B1(_1302_),
    .X(_1303_));
 sky130_fd_sc_hd__o22a_1 _3438_ (.A1(\four_man[51] ),
    .A2(net207),
    .B1(_1301_),
    .B2(_1303_),
    .X(_0175_));
 sky130_fd_sc_hd__o21a_2 _3439_ (.A1(_0431_),
    ...
    .B1(net208),
    .X(_1304_));
 sky130_fd_sc_hd__a22o_1 _3440_ (.A1(\expmiddled[0] ),
    .A2(net214),
    .B1(_1304_),
    .B2(\expmiddlec[0] ),
    .X(_0176_));
 sky130_fd_sc_hd__a22o_1 _3441_ (.A1(\expmiddled[1] ),
    .A2(net213),
    .B1(_1304_),
    .B2(\expmiddlec[1] ),
    .X(_0177_));
 sky130_fd_sc_hd__a22o_1 _3442_ (.A1(\expmiddled[2] ),
    .A2(net214),
    .B1(_1304_),
    .B2(\expmiddlec[2] ),
    .X(_0178_));
 sky130_fd_sc_hd__a22o_1 _3443_ (.A1(\expmiddled[3] ),
    .A2(net214),
    .B1(_1304_),
    .B2(\expmiddlec[3] ),
    .X(_0179_));
 sky130_fd_sc_hd__a22o_1 _3444_ (.A1(\expmiddled[4] ),
    .A2(net213),
    .B1(_1304_),
    .B2(\expmiddlec[4] ),
    .X(_0180_));
 sky130_fd_sc_hd__a22o_1 _3445_ (.A1(\expmiddled[5] ),
    .A2(net213),
    .B1(_1304_),
    .B2(\expmiddlec[5] ),
    .X(_0181_));
 sky130_fd_sc_hd__a22o_1 _3446_ (.A1(\expmiddled[6] ),
    .A2(net213),
    .B1(_1304_),
    .B2(\expmiddlec[6] ),
    .X(_0182_));
 sky130_fd_sc_hd__a22o_1 _3447_ (.A1(\expmiddled[7] ),
    .A2(net213),
    .B1(_1304_),
    .B2(\expmiddlec[7] ),
    .X(_0183_));
 ...
 sky130_fd_sc_hd__a31o_1 _3458_ (.A1(net218),
    ...
    .B1(_1314_),
    .X(_1315_));
 sky130_fd_sc_hd__o22a_1 _3459_ (.A1(\four_man[52] ),
    .A2(net206),
    .B1(_1313_),
    .B2(_1315_),
    .X(_0184_));
 sky130_fd_sc_hd__a22o_1 _3460_ (.A1(\expadd[0] ),
    .A2(net214),
    .B1(net166),
    .B2(_1304_),
    .X(_0185_));
 ...
 sky130_fd_sc_hd__o211a_1 _3463_ (.A1(_0471_),
    ...
    .C1(net208),
    .X(_1316_));
 sky130_fd_sc_hd__a21o_1 _3464_ (.A1(\expadd[3] ),
    .A2(net213),
    .B1(_1316_),
    .X(_0188_));
 sky130_fd_sc_hd__nand2_1 _3465_ (.A(_0530_),
    .B(_0543_),
    .Y(_1317_));
 sky130_fd_sc_hd__and2_1 _3466_ (.A(\expadd[4] ),
    .B(net213),
    .X(_1318_));
 ...
 sky130_fd_sc_hd__o21ai_1 _3469_ (.A1(_0534_),
    ...
    .B1(_0544_),
    .Y(_1320_));
 sky130_fd_sc_hd__a22o_1 _3470_ (.A1(\expadd[5] ),
    .A2(net213),
    .B1(_1319_),
    .B2(_1320_),
    .X(_0190_));
 sky130_fd_sc_hd__a21o_1 _3471_ (.A1(\expadd[6] ),
    .A2(net213),
    .B1(_1319_),
    .X(_0191_));
 sky130_fd_sc_hd__a21o_1 _3472_ (.A1(\expadd[7] ),
    .A2(net213),
    .B1(_1319_),
    .X(_0192_));
 ...
 sky130_fd_sc_hd__a31o_1 _3486_ (.A1(\mantisaresult[54] ),
    ...
    .B1(_1331_),
    .X(_1332_));
 sky130_fd_sc_hd__o22a_1 _3487_ (.A1(\four_man[53] ),
    .A2(net207),
    .B1(_1330_),
    .B2(_1332_),
    .X(_0195_));
 ...
 sky130_fd_sc_hd__a311o_1 _3506_ (.A1(\mantisaresult[55] ),
    ...
    .C1(net216),
    .X(_1345_));
 sky130_fd_sc_hd__o22a_1 _3507_ (.A1(\four_man[54] ),
    .A2(net207),
    .B1(_1343_),
    .B2(_1345_),
    .X(_0202_));
 ...
 sky130_fd_sc_hd__a31o_1 _3518_ (.A1(\mantisaresult[56] ),
    ...
    .B1(_1355_),
    .X(_1356_));
 sky130_fd_sc_hd__o22a_1 _3519_ (.A1(\four_man[55] ),
    .A2(net206),
    .B1(_1354_),
    .B2(_1356_),
    .X(_0203_));
 ...
 sky130_fd_sc_hd__a31o_1 _3528_ (.A1(\mantisaresult[57] ),
    ...
    .B1(_1364_),
    .X(_1365_));
 sky130_fd_sc_hd__o22a_1 _3529_ (.A1(\four_man[56] ),
    .A2(net207),
    .B1(_1363_),
    .B2(_1365_),
    .X(_0204_));
 ...
 sky130_fd_sc_hd__a31o_1 _3540_ (.A1(\mantisaresult[58] ),
    ...
    .B1(_1375_),
    .X(_1376_));
 sky130_fd_sc_hd__o22a_1 _3541_ (.A1(\four_man[57] ),
    .A2(net207),
    .B1(_1374_),
    .B2(_1376_),
    .X(_0205_));
 ...
 sky130_fd_sc_hd__a31o_1 _3552_ (.A1(\mantisaresult[59] ),
    ...
    .B1(_1386_),
    .X(_1387_));
 sky130_fd_sc_hd__o22a_1 _3553_ (.A1(\four_man[58] ),
    .A2(net206),
    .B1(_1385_),
    .B2(_1387_),
    .X(_0206_));
 ...
 sky130_fd_sc_hd__a31o_1 _3564_ (.A1(\mantisaresult[60] ),
    ...
    .B1(_1397_),
    .X(_1398_));
 sky130_fd_sc_hd__o22a_1 _3565_ (.A1(\four_man[59] ),
    .A2(net207),
    .B1(_1396_),
    .B2(_1398_),
    .X(_0207_));
 ...
 sky130_fd_sc_hd__a221o_1 _3575_ (.A1(\mantisaresult[63] ),
    ...
    .C1(_1407_),
    .X(_1408_));
 sky130_fd_sc_hd__o21a_1 _3576_ (.A1(\four_man[60] ),
    .A2(net207),
    .B1(_1408_),
    .X(_0208_));
 ...
 sky130_fd_sc_hd__buf_2 fanout213 (.A(inf2),
    .X(net213));
 sky130_fd_sc_hd__clkbuf_2 fanout214 (.A(inf2),
    .X(net214));
